...
import { studentTabs } from "../../data/Data";
import { FiMenu, FiX } from "react-icons/fi";
import S_Dashboard from "../../components/student_subsections/S_Dashboard";
import Find_Tutors from "../../components/student_subsections/Find_Tutors";
import My_Bookings from "../../components/student_subsections/My_Bookings";
import Join_Session from "../../components/student_subsections/Join_Session";
        ...
        <div className="p-6 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/60 text-xs">Student Panel</p>
            </div>
          </div>
        </div>
        ...
        <div className="sticky top-0 z-20 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between shadow-sm">
          <div className="ml-10 md:ml-0">
            <h2 className="text-xl font-bold text-gray-800">
              {studentTabs[activeBtn]?.icon} {studentTabs[activeBtn]?.title}
            </h2>
